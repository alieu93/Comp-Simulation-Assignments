function generateTransformMatrix(canvasWidth, canvasHeight, translation, scale, rotation) {
  // compute the world matrix
  var aspect = canvasWidth / canvasHeight;
  var fieldOfViewInRadians = 1.0;
  var projectionMatrix = makePerspective(fieldOfViewInRadians, aspect, 1, 2000);
  //var perspectiveFactor = 0.6;
  //var zToWMatrix = makeZToWMatrix(perspectiveFactor);
...
function makeZToWMatrix(perspectiveFactor) {
  return [
    1, 0, 0, 0,
    0, 1, 0, 0,
